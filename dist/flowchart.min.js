...
/* harmony default export */ var js_line = (Baseline);
...
BaseModule.prototype.createdragableRect = function() {
    ...
    $('body').on('dragstart', '#' + this.feId +'>.title-wraper>.dragableRect', function(event)  {
        ...
        if (!focuesLine) {
            var elementPro = '',
                line;
            line = new js_line({ originX: self.flowchart.originX, originY: self.flowchart.originY});
...
Flowchart.prototype.moduleLineRestore = function(obj, scrollDistance) {
    ...
    if (obj.feNextId) {
        ...
        var line = new js_line({ originX: this.originX, originY: this.originY, feId });
        line.setPoint({
            start: { feId: obj.feId },
...
var css_flowchart = __webpack_require__(0);
...
/* harmony default export */ var src = __webpack_exports__["default"] = (flowchart);
