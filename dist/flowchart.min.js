...
// CONCATENATED MODULE: ./src/js/svg.drawShape.js
...
var raphael_min = __webpack_require__(0);
...
// CONCATENATED MODULE: ./src/js/flowchart.shape.js
...
raphael_min_default.a.fn.html = raphael_min_default.a.fn.html || function(html, x, y, width, height) { 
  ...
  f.hide = function() {
    jquery_default()(f.node).hide();
  }
  f.show = function() {
    jquery_default()(f.node).show();
  }
  return f; 
} 
...
// CONCATENATED MODULE: ./src/js/module.default.js
var defaultOpt = {
...
/* harmony default export */ var module_default = (defaultOpt);
...
function BaseModule(options = {}) {
  Object.assign(this, module_default, options);
...
// CONCATENATED MODULE: ./src/js/flowchart.default.js
var flowchart_default_defaultOpt = {
    width: 1900,
    height: 1000,
    themeColor: '#12d2cb', //主题颜色
    rectWidth: 12, //节点宽度
    deleteIcon: 'icon-IVR-shanchu', // 删除模块icon class
    deleteLineIcon: 'icon-IVR-shanchu', //删除连线的icon class
    wraper: 'body', // flowchart wraper
    deleteLineIconWidth: 23
}
/* harmony default export */ var flowchart_default = (flowchart_default_defaultOpt);
// CONCATENATED MODULE: ./src/js/flowchart.js
/**
 * DEVELOPED BY
...
function Flowchart(options = {}) {
  ...
  Object.assign(this, flowchart_default, options)
  ...
  this.paper = raphael_min_default()('svg-wraper', this.width, this.height);
...
// CONCATENATED MODULE: ./src/js/flowchart.public.js
...
/* harmony default export */ var flowchart_public = (flowchart);

// EXTERNAL MODULE: ./src/css/flowchart.css
var css_flowchart = __webpack_require__(2);

// CONCATENATED MODULE: ./src/index.js



window.Flowchart = flowchart_public
/* harmony default export */ var src = __webpack_exports__["default"] = (flowchart_public);
